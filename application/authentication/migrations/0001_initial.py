    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('', ' -- '), ('doctor', 'Doctor'), ('health_worker', 'Health Worker'), ('patient', 'Patient'), ('medical_rep', 'Medical Representative'), ('other', 'Other')], default=0, max_length=16)),
                ('user_status', models.CharField(choices=[('pending_approval', 'Approval Pending'), ('approved', 'Approved'), ('rejected', 'Rejected'), ('on_hold', 'On Hold')], default=0, max_length=16)),
